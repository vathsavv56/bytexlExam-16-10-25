...
const { returnBook } = require('../lib/data')
...
module.exports = async function handler(req, res) {
  if (req.method === 'POST') {
    try {
      ...
      const result = returnBook(userId, bookId)
      ...
      if (result.error === 'ALL_COPIES_ALREADY_RETURNED') return badRequest(res, 'All copies already returned')
